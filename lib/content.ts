...
export const REVIEWS: Review[] = [
  ...
  },
  {
    ...
    verdict: "A compact all-in-one with enough drive for serious floorstanders, keeping the rack visually quiet and the system easy to live with.",
    rating: 4.8,
    href: reviewPath("naim-uniti-nova-pe"),
    cta: "Read review",
    image: REVIEW_IMAGES.naimUnitiNovaPe,
    alt: "Naim Uniti Nova PE streaming amplifier",
    seoTitle: "Naim Uniti Nova PE review: a quiet streaming amplifier for modern rooms",
    seoDescription:
      "Naim Uniti Nova PE review: a compact streaming amplifier that keeps the room visually quiet while supplying source, DAC, and power.",
    body: [
      "Naim Uniti Nova PE makes sense when the room should not become a rack. It is a streaming amplifier, DAC and control center in one chassis, so the system can stay visually quiet without feeling compromised.",
      "The match is about discipline rather than spectacle. The Nova PE supplies power and source handling without asking for a wall of boxes, cables and shelves.",
  ...
  },
  {
    ...
    seoTitle: "Rega Planar 8 review: analog restraint for a clean hi-fi system",
    seoDescription:
      "Rega Planar 8 review: a skeletal turntable with low visual mass, focused analog playback, and room-friendly restraint.",
    body: [
      "Rega Planar 8 works because it looks engineered without dominating the room. Its skeletal plinth reads as technical, but the footprint stays low and light.",
      ...
      "On a visual level it is one of the easier sources to place in a serious living-room system. The shape is recognizable, restrained, and honest about what it is.",
    ],
  ...
  },
  {
    ...
    seoTitle: "IsoAcoustics GAIA Neo review: practical support for floorstanding speakers",
    seoDescription:
      "IsoAcoustics GAIA Neo review: discreet isolation feet for placement, floor contact, and focus in real listening rooms.",
    body: [
      ...
      "With floorstanding speakers, placement is part of the listening experience: cabinet height, room boundaries and floor contact all matter. Good feet make small adjustments more repeatable and protect the visual calm of the setup.",
